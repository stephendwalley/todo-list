...
const todoPage = (todo) => {
	...
	title.onclick = function () {
		...
		saveTitle.onclick = function () {
			...
			detailsModal.remove();
			todoPage(todo);
			(0,_localStorage__WEBPACK_IMPORTED_MODULE_2__.updateStorage)(_project__WEBPACK_IMPORTED_MODULE_3__.projectList.projectList);
	...
	if (todo.dueDate != null) {
		dueDate.innerHTML = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.default)(new Date(todo.dueDate), "MMM d");
	} else {
	...
	dueDate.onclick = function () {
		...
		saveDate.onclick = function () {
			let updatedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.default)(new Date(editDateDiv.value), "MMM d");
